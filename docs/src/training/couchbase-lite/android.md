...
Install Couchbase Lite in your Android Studio project. The following guide shows you how to include Couchbase Lite using Gradle dependencies.

## Gradle

Expand the **app** folder and open the **build.gradle** file.
![](images/android-build-gradle.png)
Add the following to the **android** section of the **build.gradle**.
```groovy
...
```
Open the top-level **build.gradle** and add the following to the **dependencies** section.
```groovy
